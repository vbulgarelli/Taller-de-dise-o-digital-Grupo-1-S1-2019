...
HD_PWD='C:/Users/Daniel/Desktop/Alu/AluModularComp/AluModularComp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALUU.tcl -notrace
